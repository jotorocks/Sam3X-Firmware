...
/*
The board assignment defines the capabilities of the mother23board and the used pins.
...
#define ORIG_X_DIR_PIN      7
#define ORIG_X_MIN_PIN      58
...
#define ORIG_Z_MAX_PIN      48
#define ORIG_Z_ENABLE_PIN   45
...
#define EXTENSION_BOARD_MS1 -1
#define EXTENSION_BOARD_MS2 -1
#define EXTENSION_BOARD_MS3 -1
// 66 -> not connected
// 25 -> not connected
